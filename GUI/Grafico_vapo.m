...
% Last Modified by GUIDE v2.5 21-May-2017 15:48:00
...
% Choose default command line output for grafico_vapor
...
position = get( handles.grafico_vapor, ...
    'Position' );
...
function graf_vapo_CreateFcn(hObject, eventdata, handles)
% axes(hObject)

imshow('Grafico_vapo.jpg')
