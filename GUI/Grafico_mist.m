...
% Last Modified by GUIDE v2.5 21-May-2017 15:37:10
...
% Choose default command line output for grafico_mist
...
position = get( handles.grafico_mistura, ...
    'Position' );
...
function graf_mist_CreateFcn(hObject, eventdata, handles)
% axes(hObject)

imshow('Grafico_mist.jpg')
